<template>
  <div>
    <h1>สั่งซื้อและส่งหลักฐานการโอนเงิน</h1><hr>
    <form v-on:submit.prevent="createBlog">
      ...
      <strong>ที่อยู่และเบอร์โทรติดต่อ : </strong>
      <p>
        <vue-ckeditor
      ...
      <b-button-group>
          <b-button variant="success" type="submit">ยืนยัน</b-button>
  ...
  methods: {
    ...
    created() {
      this.config.toolbar = [
        ...
        {
          name: "editing",
          item: ["Find", "Replace", "-", "SelectAll", "-", "Scayt"],
        },
        {
          name: "from",
          item: [
        ...
        {
          name: "styles",
          item: ["Styles", "Format", "Font", "FontSize"],
        },
        {
          name: "colors",
